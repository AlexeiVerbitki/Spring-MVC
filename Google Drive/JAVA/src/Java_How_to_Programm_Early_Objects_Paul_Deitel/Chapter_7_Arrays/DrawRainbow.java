...
// Fig. 7.25: DrawRainbow.java // Drawing a rainbow using arcs and an array of colors.
...
public class DrawRainbow extends JPanel
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        int radius = 200; // radius of an arc
        ...
        for (int counter = colors.length; counter > 0; counter--)
        {
            ...
            g.drawArc(centerX - counter * radius,
                    centerY - counter * radius,
                    counter * radius * 2, counter * radius * 2, 0, i);
        }
    }
