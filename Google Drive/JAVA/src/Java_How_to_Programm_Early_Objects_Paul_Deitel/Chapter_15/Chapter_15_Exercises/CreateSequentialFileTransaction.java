...
class CreateSequentialFileTransaction
{
...

   {
      try 
      {
         output = new ObjectOutputStream(
            Files.newOutputStream(Paths.get("Transaction.ser")));
      }
   ...
   public static void addRecords()
   {
      ...
      while (input.hasNext()) // loop until end-of-file indicator
      {
         try 
         {
            ...
            TransactionRecord record = new TransactionRecord (input.nextInt(), input.nextDouble());
