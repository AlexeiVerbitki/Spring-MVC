...
import Java_How_to_Programm_Early_Objects_Paul_Deitel.Chapter_5.AutoPolicy;

// Fig. 5.12: AutoPolicyTest.java // Demonstrating Strings in switch.
public class AutoPolicyTest
{
    ...
    public static void policyInNoFaultState(AutoPolicy policy)
    {
        ...
        System.out.println("The auto policy:");
        System.out.printf(
                "Account2 #: %d; Car: %s;%nState %s %s a no-fault state%n%n",
