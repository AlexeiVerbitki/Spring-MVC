package Java_How_to_Programm_Early_Objects_Paul_Deitel.Chapter_12.fig12_06_07;// Fig. 12.6: LabelFrame.java
...
public class LabelFrame extends JFrame 
{
   ...
   public LabelFrame()
   {
      ...
      label2 = new JLabel("Label 2 with text and icon", bug,
         SwingConstants.LEFT);
      label2.setToolTipText("This is label2"); //      label2.setHorizontalTextPosition(SwingConstants.LEFT);
